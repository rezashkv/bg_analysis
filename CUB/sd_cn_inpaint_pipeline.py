# source: https://github.com/vijishmadhavan/UnpromptedControl/blob/master/src/pipeline_stable_diffusion_controlnet_inpaint.py
...
class StableDiffusionControlNetInpaintPipeline(StableDiffusionControlNetPipeline):
    ...
    def __call__(
        ...
        self.check_inputs(
            prompt, control_image, callback_steps, negative_prompt=negative_prompt, prompt_embeds=prompt_embeds,
